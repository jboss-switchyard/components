 ...
 */
package org.switchyard.component.camel.rss.model.v1;
...
import org.switchyard.component.camel.rss.model.v1.V1CamelRSSBindingModel;
 ...
 */
public class V1CamelRSSBindingModel extends V1BaseCamelBindingModel
     ...
     */
    public V1CamelRSSBindingModel(String namespace) {
        super(RSS, namespace);
     ...
     */
    public V1CamelRSSBindingModel(Configuration config, Descriptor desc) {
        super(config, desc);
    }
    ...
    @Override
    public V1CamelRSSBindingModel setFeedURI(URI uri) {
    ...
    @Override
    public V1CamelRSSBindingModel setLastUpdate(Date date) {
        final DateFormat lastUpdateDateFormat = new SimpleDateFormat(DATE_FORMAT_STRING);
    ...
    @Override
    public V1CamelRSSBindingModel setFeedHeader(Boolean feedHeader) {
    ...
    @Override
    public V1CamelRSSBindingModel setFilter(Boolean filtered) {
    ...
    @Override
    public V1CamelRSSBindingModel setSortEntries(Boolean sorted) {
    ...
    @Override
    public V1CamelRSSBindingModel setSplitEntries(Boolean split) {
    ...
    @Override
    public V1CamelRSSBindingModel setThrottleEntries(Boolean throttled) {
    ...
    @Override
    public V1CamelRSSBindingModel setConsumer(CamelScheduledPollConsumer consumer) {
        Configuration config = getModelConfiguration().getFirstChild(CONSUME);
        if (config != null) {
