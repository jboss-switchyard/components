 ...
 */
public class V1CamelRSSBindingModelTest extends V1BaseCamelServiceBindingModelTest<V1CamelRSSBindingModel, FeedEndpoint> {

    private static final String CAMEL_XML = "/v1/switchyard-rss-binding.xml";
    ...
    public V1CamelRSSBindingModelTest() throws ParseException {
    ...
    @Override
    protected void createModelAssertions(V1CamelRSSBindingModel model) {
    ...
    @Override
    protected V1CamelRSSBindingModel createTestModel() {
        V1CamelRSSBindingModel abm = new V1CamelRSSBindingModel(CamelRSSNamespace.V_1_0.uri())
            .setFeedURI(FEED_URI)
        ...
        CamelScheduledPollConsumer consumer = new V1CamelScheduledPollConsumer(CamelRSSNamespace.V_1_0.uri(), V1CamelRSSBindingModel.CONSUME)
