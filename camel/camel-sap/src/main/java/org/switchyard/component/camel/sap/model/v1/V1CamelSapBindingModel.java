 ...
 */
public class V1CamelSapBindingModel extends V1BaseCamelBindingModel
    ...
    /**
     * Create a new V1CamelSapBindingModel.
     * @param namespace namespace
     */
    public V1CamelSapBindingModel(String namespace) {
        super(SAP, namespace);
     ...
     */
    public V1CamelSapBindingModel(final Configuration config, final Descriptor desc) {
        super(config, desc);
    }
    ...
    @Override
    public V1CamelSapBindingModel setServer(String server) {
    ...
    @Override
    public V1CamelSapBindingModel setDestination(String destination) {
    ...
    @Override
    public V1CamelSapBindingModel setRfcName(String rfcName) {
    ...
    @Override
    public V1CamelSapBindingModel setTransacted(Boolean transacted) {
