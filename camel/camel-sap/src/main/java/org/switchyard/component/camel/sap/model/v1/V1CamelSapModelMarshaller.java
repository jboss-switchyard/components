 ...
 */
public class V1CamelSapModelMarshaller extends V1BaseCamelMarshaller {

    private static final String BINDING_SAP = BindingModel.BINDING + '.' + V1CamelSapBindingModel.SAP;
     ...
     */
    public V1CamelSapModelMarshaller(Descriptor desc) {
        super(desc);
    }
    ...
    public Model read(Configuration config) {
        ...
        if (BINDING_SAP.equals(name)) {
            return new V1CamelSapBindingModel(config, desc);
        }
