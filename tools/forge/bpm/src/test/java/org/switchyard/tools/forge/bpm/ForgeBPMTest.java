 ...
 */
public class ForgeBPMTest extends AbstractShellTest {
    ...
    public static JavaArchive getDeployment() {
        ...
        archive.addPackage(BPMFacet.class.getPackage());
        return archive;
    }
    ...
    private void testCreateBPMService() throws Exception {
        queueInputLines(BPM_SERVICE);
        getShell().execute("project install-facet switchyard.bpm");
        getShell().execute("bpm-service create");
