 ...
 */
public interface LoggersModel extends Model {

    /** The "loggers" name. */
    public static final String LOGGERS = "loggers";

    /**
     * Gets the child logger models.
     * @return the child logger models
     */
    public List<LoggerModel> getLoggers();

    /**
     * Adds a child logger model.
     * @param logger the child logger model
     * @return this LoggersModel (useful for chaining)
     */
