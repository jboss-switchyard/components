 ...
 */
public interface ListenersModel extends Model {
     ...
     * @return the child listener models
     */
    public List<ListenerModel> getListeners();

    /**
     * Adds a child listener model.
     * @param listener the child listener model
     * @return this ListenersModel (useful for chaining)
     */
