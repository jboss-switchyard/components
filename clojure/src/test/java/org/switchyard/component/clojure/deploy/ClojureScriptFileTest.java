...
@SwitchYardTestCaseConfig(config = "switchyard-clojure-scriptFile.xml", mixins = CDIMixIn.class)
public class ClojureScriptFileTest {

    @ServiceOperation("OrderService.getTitleForItem")
    private Invoker _getTitleForItem;

    @Test
    public void executeClojureScriptFromFileOnClasspath() {
