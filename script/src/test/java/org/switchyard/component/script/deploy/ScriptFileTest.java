...
/**
 * Functional test for ScriptActivator.
 * 
...
@SwitchYardTestCaseConfig(config = "switchyard-script-scriptFile.xml", mixins = CDIMixIn.class)
public class ScriptFileTest {
    ...
    @Test
    public void executeScriptFromFileOnClasspath() {
        final String title = _getTitleForItem.sendInOut(10).getContent(String.class);
        assertThat(title, is(equalTo("10:Fletch")));
    }
