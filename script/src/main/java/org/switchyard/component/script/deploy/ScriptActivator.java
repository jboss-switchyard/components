...
/**
 * Activator for implemenations.script.
 * 
 * @author Jiri Pechanec
 * @author Daniel Bevenius
 *
 */
public class ScriptActivator extends BaseActivator {
    
    private static final String[] TYPES = new String[] {"script"};
    ...
    public ServiceHandler activateService(QName name, ComponentModel config) {
        return new ScriptHandler((ScriptComponentImplementationModel)config.getImplementation());
    }
