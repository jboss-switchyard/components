...
public interface JCAMessages {
    ...
    String noOperationSelectorConfigured();
    
    /**
     * pleaseAddOperationSelector method definition.
     * @return String
     */
    @Message(id = 37237, value = "Please add an operationSelector element.")
    String pleaseAddOperationSelector();
