...
/**
 * binding.jca/*Connection/resourceAdapter model.
 * 
...
public interface ResourceAdapterModel extends BasePropertyContainerModel {
     ...
     *  
     * @param name resource adapter name to set
     * @return {@link ResourceAdapterModel} to support method chaining
     */
    ResourceAdapterModel setName(String name);
